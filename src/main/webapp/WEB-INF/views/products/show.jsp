			...
			<div id="header-content">
				<nav id="main-nav">
					<ul class="clearfix">
						 ...
						 <li><a href="" rel="nofollow">Seu carrinho (${shoppingCart.quantity}) </a></li> 
						<li><a href="" rel="nofollow">Seu carrinho (${sessionScope['scopedTarget.shoppingCart'].quantity}) </a></li>
	...
	<article id="${product.title}" itemscope
		...
		<div class="container">
			...
			<section class="data product-detail">
				...
				<p>
					N�mero de paginas: <span itemprop="numberOfPages">${product.pages}</span>
				</p>
